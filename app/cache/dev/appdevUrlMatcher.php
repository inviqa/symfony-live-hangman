...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Sensio\\Bundle\\HangmanBundle\\Controller\\GameController::indexAction',  '_route' => 'homepage',);
        }
        ...
        // play_letter
        if (0 === strpos($pathinfo, '/game/letter') && preg_match('#^/game/letter/(?<letter>[A-Z])$#s', $pathinfo, $matches)) {
        ...
        if ($pathinfo === '/registration') {
            return array (  '_controller' => 'Sensio\\Bundle\\HangmanBundle\\Controller\\PlayerController::registrationAction',  '_route' => 'registration',);
        }
